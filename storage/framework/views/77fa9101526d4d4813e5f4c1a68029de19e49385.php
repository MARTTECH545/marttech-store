...
<section  class="container features">
    <div class="row">
        <div class="col-lg-12 text-center">
           ...
           <a href="<?php echo e($website->website); ?>"><button type="button" class="btn-primary" id="proceed"  style="display: none;">Go to Link</button></a>
            ...
            setInterval(function() {
                ...
                if (counter === 0) {
                    $.ajax({
                        'url': '/api/short_links',
                        data: {
                            "client_id": "<?php echo e($website->client_id); ?>"
                        },
                        'type': 'GET',
...
<?php /**PATH D:\xampp\htdocs\Booster\resources\views/ads.blade.php ENDPATH**/ ?>