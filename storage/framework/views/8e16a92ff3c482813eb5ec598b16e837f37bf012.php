                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form role="form" method="post" action="/administrator/change_password">
                                            ...
                                            <div class="form-group">
                                                <label><?php echo e(trans('messages.Change Email')); ?></label>
                                                <input type="email" pattern=".{6,}" id="email" name="email"
                                                       class="form-control" placeholder="<?php echo e(trans('messages.Change Email')); ?>"
                                                >
                                            </div>
                                    ...
                                    <a href="/administrator/account/delete/<?php echo e(Auth::user()->id); ?>" Onclick="return ConfirmDelete();" type="button" style="width:100%"
                                       class="btn btn-lg btn-danger align-right"><i class="fa fa-trash"></i><?php echo e(trans('messages.Delete Account')); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrator.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Booster\resources\views/administrator/settings.blade.php ENDPATH**/ ?>